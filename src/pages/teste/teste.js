...
import { cpfMask, cnpjMask, phoneMask, cepMask, pisMask } from '../../utils/masks';
  ...
  return (
    <Container>
      ...
      <form>
        ...
        <Input type="text" name="cpf" value={cpfMask(cpf)} onChange={e => setCPF(e.target.value)} />
        ...
        <Input type="text" name="pis" value={pisMask(pis)} onChange={e => setPis(e.target.value)} />
      </form>
    </Container>
  );
}
